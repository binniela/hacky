...
const SSOPopup: React.FC<SSOPopupProps> = ({ isOpen, onClose, mode }) => {
      ...
      <div className="bg-white rounded-lg p-8 max-w-md w-full">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-semibold text-gray-700">
            {mode === 'login' ? 'Sign in to Auxilium' : 'Create an Auxilium account'}
          </h2>
        ...
        {mode === 'signup' && (
          <p className="text-sm text-gray-600 mb-4">
            ...
            <button onClick={() => {}} className="text-purple-600 hover:underline">
              Sign in
            </button>
          </p>
        )}
        ...
        {mode === 'login' && (
          <div className="mt-4">
            <button onClick={() => {}} className="text-sm text-purple-600 hover:underline">
              Forgot password?
            </button>
          </div>
        )}
